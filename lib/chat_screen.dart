...
import 'package:airline_chatbot_application/provider.dart';
import 'package:airline_chatbot_application/chat_bubble.dart';
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    var message = chatProvider.messages.reversed
                        .toList()[index - (chatProvider.isLoading ? 1 : 0)];
                    return ChatBubble(
              ...
              children: [
                Expanded(
                  child: TextField(
                    ...
                    decoration:
                        InputDecoration(hintText: "Ask about flight status..."),
                    onSubmitted: (_) =>
